...
date: 2017-11-11T14:05:05+07:00
lang: java-core
categories:
- Java
- Core
...
Untuk konversi tipe data, ini juga merupakan operator juga. Jadi klo di materi [sebelumya]({% post_url java-core/2017-11-07-conversi-tipe-data %}) Semua dilakukan secara otomatis tapi jika tidak ada dalam flow conversion kita bisa override it, do it manualy. using operator `()`. Berikut contohnya
