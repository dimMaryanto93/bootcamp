...
![Hasil soal no 1]({{ site.baseurl }}/resources/downloads/imgs/psql/quis-2/soal1.png)
Dengan ketentuan:
...
![Hasil soal no 2]({{ site.baseurl }}/resources/downloads/imgs/psql/quis-2/soal2.png)
Ketentuannya:
...
![Hasil soal no 3]({{ site.baseurl }}/resources/downloads/imgs/psql/quis-2/soal3.png)
...
![Hasil no 4]({{ site.baseurl }}/resources/downloads/imgs/psql/quis-2/soal4.png)
...
![hasil no 5]({{ site.baseurl }}/resources/downloads/imgs/psql/quis-2/soal5.png)
